...
3 ÷ 1 = 
```
- [x] 소숫점 계산도 가능해야 합니다. 단 자바스크립트 부동소수점에 관한 문제로 인해 정확하게 답을 
낼 필요는 없을 듯합니다. [0.30000000000000004](https://0.30000000000000004.com/)
```js
0.1 + 0.2  === 0.3  // false
```
...
원금 50,000원에 이자(5%)는?
--> 50,000 × 5%(0.05) = 2,500  // ×, ÷ 연산 일때는 좌항과 관계없이 바로 최종값이 백분율계산입니다. 
